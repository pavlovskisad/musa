  ...
  return (
    <div className="h-full relative anim-slide-right overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-auto scrollable">
        <div className="px-6 pb-12" style={{ paddingTop: '220px' }}>
          {/* Investment */}
          {hasInvestment && (
            <div className="bg-surface border border-app rounded-2xl p-5 space-y-2.5 mb-4">
      ...
      <div className="hero-glass absolute top-0 left-0 right-0 z-10">
        ...
        {/* Wallet + PAXG hero */}
        <div className="relative px-6 pt-2 pb-4" style={{ zIndex: 2 }}>
          <button onClick={copyAddress} className="press flex items-center gap-3 mb-4 w-full text-left">
            <div
